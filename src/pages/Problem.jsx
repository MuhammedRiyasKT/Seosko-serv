    ...
    <main>
      ...
      <AnimatedSection className="py-5" bgVectors={true}>
        <Row className="justify-content-center text-center mb-5">
          <Col md={8}>
            <h2 className="section-title mb-4">THE CHALLENGES</h2>
            <p className="lead">
            ...
            <AnimatedElement animation="slideInLeft" delay={1}>
              <Card className="h-100 border-0 shadow-sm">
                ...
                <Card.Body className="p-4">
                  <h2 className="h3 mb-3">A Quick Turnaround</h2>
                  <p>
          ...
          <Col md={6} className="mb-4">
            <AnimatedElement animation="slideInRight" delay={1}>
              <Card className="h-100 border-0 shadow-sm">
                ...
                <Card.Body className="p-4">
                  <h2 className="h3 mb-3">A Bigger Team</h2>
                  <p>
          ...
          <Col md={6} className="mb-4">
            <AnimatedElement animation="slideInLeft" delay={2}>
              <Card className="h-100 border-0 shadow-sm">
                ...
                <Card.Body className="p-4">
                  <h2 className="h3 mb-3">A Bigger Office</h2>
                  <p>
          ...
          <Col md={6} className="mb-4">
            <AnimatedElement animation="slideInRight" delay={2}>
              <Card className="h-100 border-0 shadow-sm">
                ...
                <Card.Body className="p-4">
                  <h2 className="h3 mb-3">What Do You Need?</h2>
                  <p>
      ...
      <AnimatedSection className="py-5 bg-light-gray" bgDots={true}>
        <Row className="justify-content-center text-center">
          <Col md={8}>
            <h2 className="section-title mb-4">THE SOLUTION</h2>
            ...
            <AnimatedElement delay={1}>
              <Card className="h-100 border-0 shadow-sm">
                ...
                <Card.Body className="text-center p-4">
                  ...
                  <h3 className="h4 mb-3">Flexible Resources</h3>
                  <p>Scale flexibly without long-term commitments or major investments.</p>
                </Card.Body>
              </Card>
            </AnimatedElement>
          </Col>
            ...
            <AnimatedElement delay={2}>
              <Card className="h-100 border-0 shadow-sm">
                ...
                <Card.Body className="text-center p-4">
                  ...
                  <p>Reduce operational costs significantly with our streamlined solutions.</p>
                </Card.Body>
              </Card>
            </AnimatedElement>
          </Col>
          <Col md={4} className="mb-4">
            <AnimatedElement delay={3}>
              <Card className="h-100 border-0 shadow-sm">
                ...
                <Card.Body className="text-center p-4">
                  <CheckCircleFill size={40} className="text-success mb-3" />
                  <h3 className="h4 mb-3">Rapid Deployment</h3>
                  <p>Get up and running quickly with our turnkey business solutions.</p>
                </Card.Body>
              </Card>
            </AnimatedElement>
          </Col>
